...
def do_clean(number=0):
    """
    Deletes out-of-date archives and old releases.

    :param number:
    The number of most recent archives/releases to keep.
    Defaults to 0, meaning all archives/releases will be deleted.
    """
